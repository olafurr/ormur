...
class QueryBuilder {
	...
	constructor(query, table, tableAlias, parentTable) {
		...
		['where', 'orderBy', 'select', 'toSQL', 'orderByRaw', 'then', 'tap', 'catch', 'map', 'bind', 'reduce', 'groupBy', 'gropuByRaw', 'whereRaw', 'whereNot', 'whereIn', 'whereNotIn', 'whereNull', 'whereNotNull', 'whereExists', 'whereNotExists', 'whereBetween', 'whereNotBetween'].forEach(fn => {
			this[fn] = function() {
