...
var QueryBuilder = function () {
  ...
  */
	function QueryBuilder(query, table, tableAlias, parentTable) {
		...
		['where', 'orderBy', 'toSQL', 'orderByRaw', 'then', 'tap', 'catch', 'map', 'groupBy', 'gropuByRaw', 'whereRaw', 'whereNot', 'whereIn', 'whereNotIn', 'whereNull', 'whereNotNull', 'whereExists', 'whereNotExists', 'whereBetween', 'whereNotBetween'].forEach(function (fn) {
			_this[fn] = function () {
